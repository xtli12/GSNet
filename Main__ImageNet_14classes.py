...
def main():
    ...
    start_epoch = 0; iteration = 0; record_acc = 0.5
    ...
    for epoch in range(start_epoch+1, opt.end_epoch):
        ...
        logger.info("Epoch [%02d], Iter[%06d], Time:%.9f, learning rate: %.9f, Train Loss: %.9f acc: %.9f " % (epoch, iteration, epoch_time, lr, train_loss, acc)) # 保存每一代epoch的参数
